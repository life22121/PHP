...
class CustomerController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $data['wallets'] = $wallets = Wallet::with('currency:id,type,symbol,logo,code,status')->where(['user_id' => Auth::user()->id])->orderBy('balance', 'ASC')->get(['id', 'currency_id', 'balance', 'is_default']);
